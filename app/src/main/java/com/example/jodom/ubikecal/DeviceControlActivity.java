...
import static com.example.jodom.ubikecal.SampleGattAttributes.CYCLING_SPEED_AND_CADENCE;
import static com.example.jodom.ubikecal.SampleGattAttributes.lookup;
   ...
   // private GraphViewSeries speedSeries;
    ...
    private void stopLogging(){
        ...
        try {
            ...
            Toast toast = Toast.makeText(getApplicationContext(), R.string.label_recording_stopped, Toast.LENGTH_LONG);
            toast.show();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void displayData(int array[]) {
        ...
        Log.d(TAG, "this is my array " + Arrays.toString(array));
        ...
        final TextView JonesView = findViewById(R.id.JonesTextView);
        JonesView.setText(String.valueOf(cumulative_wheel_revolutions_));
